...
CONFIG_FILE="/etc/vector/aggregator.toml"
...
# 设置环境变量
export AGGREGATOR_ID="${AGGREGATOR_ID:-$(hostname)}"
...
# 启动 Vector
echo "启动 Vector Aggregator 服务..."
echo "聚合器 ID: $AGGREGATOR_ID"
